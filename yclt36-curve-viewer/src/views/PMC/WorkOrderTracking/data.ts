...
export function generateMockData(): WorkOrderTrackItem[] {
  ...
  for (let i = 0; i < 20; i++) {
    ...
    data.push({
      ...
      生产完成率: rate,
      交货计划: JSON.stringify([
        { 交货日期: '2026-01-01', 交货数量: i % 7 === 1 ? 2000 : i % 7 === 2 ? 500 : i % 7 === 4 ? 5 : i % 7 === 3 ? 49 : i % 7 === 0 ? 79 : 0, 状态: '满足' },
        { 交货日期: '2026-01-03', 交货数量: i % 7 === 1 ? 2000 : 0, 状态: '满足' },
        { 交货日期: '2026-01-04', 交货数量: i % 7 === 4 ? 500 : 0, 状态: '部分满足' },
        { 交货日期: '2026-01-05', 交货数量: 0, 状态: '不满足' }
      ])
    })
  }
  return data
